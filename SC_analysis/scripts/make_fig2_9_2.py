#!/usr/bin/env python3
"""Fig. 2.9_2 – Yearly portion by experimental evidence (line chart, multi-label)."""
...
ax.set_ylabel("Portion of experiment tags", fontsize=11)
ax.set_title("Fig. 2.9_2 – Yearly Portion by Experimental Evidence", fontsize=13, fontweight="bold")
ax.set_xlim(YEARS[0], YEARS[-1])
ax.set_ylim(0, 1)
ax.legend(fontsize=6.5, loc="upper right", ncol=2, framealpha=0.75)
ax.grid(alpha=0.3, linewidth=0.5)
ax.spines[["top", "right"]].set_visible(False)
fig.tight_layout()
fig.savefig(OUT_DIR / "fig2_9_2.png", dpi=150, bbox_inches="tight")
print("Saved → fig2_9_2.png")
plt.close()

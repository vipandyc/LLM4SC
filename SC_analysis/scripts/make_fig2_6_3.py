#!/usr/bin/env python3
"""Fig. 2.6_3 – Publication timeline stacked by computational evidence (multi-label)."""
...
ax.set_title("Fig. 2.6_3 – Publication Timeline by Computational Evidence", fontsize=13, fontweight="bold")
ax.legend(fontsize=7.5, loc="upper left", ncol=1, framealpha=0.75)
ax.set_xlim(1955, 2025)
ax.grid(axis="y", alpha=0.3, linewidth=0.5)
ax.spines[["top", "right"]].set_visible(False)
fig.tight_layout()
fig.savefig(OUT_DIR / "fig2_6_3.png", dpi=150, bbox_inches="tight")
print("Saved → fig2_6_3.png")
plt.close()
